...
* **LaSOT:star2:**
     ...
     | TrDimp (CVPR21)           | 0.639  |                   |   [Paper]()/[Code]() |
...
* **TrackingNet:star2:**
     ...
     | TrDimp (CVPR21)           | 0.784  | 0.833   |                  |   [Paper]()/[Code]() |
...
* **OTB-100/OTB-2015:star2:**
     ...
     | TrDimp (CVPR21)           | 0.711  |        |   [Paper]()/[Code]() |
...
* **NFS**
     ...
     | Tracker                   | Success Score    | Speed (fps) | Paper/Code |
     |:-----------               |:----------------:|:----------------:|:----------------:|
     | TrDimp (CVPR21)           | 0.665  |                   |   [Paper]()/[Code]() |
...
* **UAV123**
     ...
     | TrDimp (CVPR21)           | 0.675  |                   |   [Paper]()/[Code]() |
...
* **2021:**
     ...
     * LightTrack: Finding Lightweight Neural Networks for Object Tracking via One-Shot Architecture Search. CVPR, 2021.  <br />  Bin Yan, Houwen Peng, Kan Wu, Dong Wang, Jianlong Fu, Huchuan Lu.  [[Paper]()][[Code](github.com/researchmm/LightTrack)] 
