...
* **TrackingNet:**
     ...
     * The performance on TrackingNet is improved very fast. Here merely list the trackers perform better than **SiamRPN++**. 
...
* **GOT-10k:**
     ...
     | SiamAttn (CVPR20)         | 0.752  | 45 (RTX 2080Ti)  | [Paper](https://arxiv.org/pdf/2004.06711.pdf)/[Code]() |
     | DiMP50 (ICCV19)           | 0.740  | 43 (GTX 1080)   | [Paper](https://arxiv.org/pdf/1904.07220.pdf)/[Code](https://github.com/visionml/pytracking)  |
     | SiamRPN++ (CVPR19)        | 0.733  | 35 (Titan XP)    | [Paper](http://openaccess.thecvf.com/content_CVPR_2019/papers/Li_SiamRPN_Evolution_of_Siamese_Visual_Tracking_With_Very_Deep_Networks_CVPR_2019_paper.pdf)/[Code](https://github.com/STVIR/pysot) |
