...
**:star:** **SwinTrack: A Simple and Strong Baseline for Transformer Tracking (https://arxiv.org/abs/2112.00995) (https://github.com/LitingLin/SwinTrack) achieves new records on many benchmarks (LaSOT, Got-10k, TrackingNet).** 
